<template>
  ...
  <span v-else :class="disabled ? 'cursor-not-allowed w-28' : 'cursor-pointer w-36'" class="text-base font-normal text-gray-400 inline-block" @click="!disabled && $emit('setShortcut')">
